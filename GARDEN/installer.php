...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'THEO_BRO_e0a7c0350ad5f9026896_20220726143920_archive.zip';
	const ARCHIVE_SIZE		 = '56574234';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e0a7c03-26143920';
    const SECONDARY_PACKAGE_HASH = '8ec0484-26143920';
	const VERSION			 = '1.4.7';
